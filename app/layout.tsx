  ...
  return (
    <html lang="es">
      <body className={inter.className}>
        <Header />
        {children}
        <Link href="https://wa.link/ryfuv1" target="_blank" className="fixed z-50 right-3 bottom-8 rounded-full bg-green-600 p-4 text-white font-bold hover:scale-110 duration-300">
